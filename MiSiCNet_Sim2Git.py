# -*- coding: utf-8 -*-
"""
Created on Tue Jan 25 15:42:39 2022
...
#%%
# fname3  = "C:/Users/behnood/Desktop/VMCNN/Diffi/A_true.mat"
# mat3 = scipy.io.loadmat(fname3)
# A_true_np = mat3["A_true"]
# A_true_np = A_true_np.transpose(2,0,1)
#%%
# fname4  = "C:/Users/behnood/Desktop/VMCNN/Diffi/E.mat"
...
#            out_HR=torch.mm(E_torch.view(p1,rmax),out_LR.view(rmax,nr1*nc1))
        ...
        #%%
            total_loss = my_loss(img_noisy_torch, net1.dconv4[0].weight,.3,out_spec)
            total_loss.backward()
